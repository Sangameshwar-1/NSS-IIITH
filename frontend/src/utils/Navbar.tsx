...
const Navbar = () => {
    ...
    // Debug: Log when showProfileDropdown changes
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        console.log("Cookie UID found:", foundUid);
        console.log("===================");
        setUid(foundUid);
    }, []);
                ...
                <div style={{
                    ...
                    {!uid ? (
                        ...
                        <div 
                            ...
                            onMouseEnter={() => {
                                console.log("Mouse entered profile container");
                                setShowProfileDropdown(true);
                            }}
                            onMouseLeave={() => {
                                console.log("Mouse left profile container");
                        ...
                        >
                            ...
                            {showProfileDropdown && (
                                <div
                                    ...
                                    onMouseEnter={() => console.log("Mouse on dropdown")}
                                >
                                    <div
                                        style={{
                                            padding: "1rem",
        ...
        <>
            ...
            >
                        ...
                        >
                            ...
                            {showProfileDropdown && (
                                ...
                                >
                                    ...
                                    <button
                                        onClick={() => window.location.replace(`http://localhost:3000/admin`)}
                                        style={{
                                            width: "100%",
                                            padding: "0.75rem 1rem",
                                            background: "transparent",
                ...
                <div style={{ 
                    ...
                    <div>UID State: {uid || "NULL"}</div>
                    <div>Type: {typeof uid}</div>
                    <div>Truthy: {uid ? "YES" : "NO"}</div>
